...
쿠키를 기반으로 사용자 정보를 서버에 저장하는 것을 의미한다. 민감한 정보를 Session DB라는 곳에 저장함으로써 개인 정보를 안전하게 지킬 수 있다. 또한 세션에 이미 로그인 정보가 저장되어 있기에 화면 이동 시 로그인이 불필요 하여 중복 로그인을 방지할 수 있습니다.
